          ...
          <ul className="flex flex-col items-center justify-center space-y-4">
            ...
            <div className="flex gap-3 py-4 items-center justify-center">
              ...
              <span className="w-96">
                ...
                <p className="text-sm md:text-md leading-tight">
                  I am proficient in MongoDB, PostgreSQL, and MySQL. I design and manage scalable, efficient databases tailored to meet application needs. Whether working with NoSQL databases like MongoDB or relational systems like PostgreSQL and MySQL, I focus on performance optimization, data integrity, and building secure, reliable solutions.
                </p>
              </span>
            </div>
